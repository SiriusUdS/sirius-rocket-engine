...
#define ADC_PRESSURE_SENSOR_1_Pin GPIO_PIN_0
#define ADC_PRESSURE_SENSOR_1_GPIO_Port GPIOC
#define ADC_PRESSURE_SENSOR_2_Pin GPIO_PIN_1
#define ADC_PRESSURE_SENSOR_2_GPIO_Port GPIOC

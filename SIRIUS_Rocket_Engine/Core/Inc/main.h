...
#define GPIO_OUTPUT_HEATPAD_NOS_Pin GPIO_PIN_10
#define GPIO_OUTPUT_HEATPAD_NOS_GPIO_Port GPIOC
#define GPIO_OUTPUT_HEATPAD_IPA_Pin GPIO_PIN_11
#define GPIO_OUTPUT_HEATPAD_IPA_GPIO_Port GPIOC
